...
<div class="flex">
    ...
    <div class="flex-1 h-screen overflow-y-auto px-6 py-24 bg-gray-50">
        ...
        <div class="bg-white rounded-xl shadow-lg w-full p-6 transition-all duration-300">
            ...
            <form action="{{ route('school.events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <input type="text" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="title" name="title" value="{{ old('title') }}" required>
                            <p class="mt-1 text-xs text-gray-500">Choose a clear, descriptive title for your event</p>
                        </div>
                        
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Description <span class="text-red-500">*</span></label>
                            <textarea class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="description" name="description" rows="6" required>{{ old('description') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="date" class="w-full pl-10 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="event_date" name="event_date" value="{{ old('event_date') }}" required>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" class="w-full pl-10 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="location" name="location" value="{{ old('location') }}" required placeholder="Room, building, or address">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="time" class="w-full pl-10 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="start_time" name="start_time" value="{{ old('start_time') }}" required>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="time" class="w-full pl-10 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="end_time" name="end_time" value="{{ old('end_time') }}">
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" class="w-full pl-10 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="organizer" name="organizer" value="{{ old('organizer') }}" placeholder="Person or department organizing this event">
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2 mt-2">
                                <label class="flex p-3 border border-gray-300 rounded-md cursor-pointer hover:border-blue-500 peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all">
                                    <input type="radio" name="status" value="upcoming" class="peer sr-only" {{ old('status', 'upcoming') == 'upcoming' ? 'checked' : '' }}>
                                ...
                                <label class="flex p-3 border border-gray-300 rounded-md cursor-pointer hover:border-green-500 peer-checked:border-green-500 peer-checked:bg-green-50 transition-all">
                                    <input type="radio" name="status" value="ongoing" class="peer sr-only" {{ old('status') == 'ongoing' ? 'checked' : '' }}>
                                    <div class="flex items-center">
                                ...
                                <label class="flex p-3 border border-gray-300 rounded-md cursor-pointer hover:border-gray-500 peer-checked:border-gray-500 peer-checked:bg-gray-50 transition-all">
                                    <input type="radio" name="status" value="completed" class="peer sr-only" {{ old('status') == 'completed' ? 'checked' : '' }}>
                                    <div class="flex items-center">
                                        <div class="w-6 h-6 border-2 rounded-full border-gray-500 flex items-center justify-center mr-3">
                                            <div class="w-3 h-3 rounded-full bg-gray-500 hidden peer-checked:block"></div>
                                        </div>
                                        <div>
                                ...
                                <label class="flex p-3 border border-gray-300 rounded-md cursor-pointer hover:border-red-500 peer-checked:border-red-500 peer-checked:bg-red-50 transition-all">
                        ...
                        <div class="mt-4">
                            <label class="flex items-center">
                                <input type="checkbox" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }}>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        radioButtons.forEach(radio => {
            radio.addEventListener('change', function() {
                ...
                document.querySelectorAll('input[name="status"] + .flex .w-3.h-3').forEach(el => {
