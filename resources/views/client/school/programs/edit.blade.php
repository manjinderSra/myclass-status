        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('school.programs.update', $program->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="coordinator" name="coordinator" value="{{ old('coordinator', $program->coordinator) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="coordinator_contact" class="form-label">Coordinator Contact</label>
                                            <input type="text" class="form-control" id="coordinator_contact" name="coordinator_contact" value="{{ old('coordinator_contact', $program->coordinator_contact) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @if($program->image_path)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $program->image_path) }}" alt="{{ $program->title }}" class="img-thumbnail" style="max-height: 200px;">
                                        </div>
                                    @endif
                                    <input type="file" class="form-control" id="image" name="image" accept="image/*">
                                    <small class="text-muted">Recommended size: 800x600 pixels, max 2MB. Leave empty to keep the current image.</small>
                                    <div class="mt-2">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $program->is_featured) ? 'checked' : '' }}>
