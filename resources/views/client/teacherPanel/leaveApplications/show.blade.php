...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('teacher.leaveApplications') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition">
...
<div class="bg-white rounded-xl shadow-lg w-full p-6 transition-all duration-300">
    ...
    <div class="mb-6">
        <h3 class="text-md font-semibold mb-3 text-gray-700">Remarks</h3>
    ...
    <div>
        ...
        <form id="updateStatusForm" action="{{ route('teacher.leaveApplications.updateStatus', $leave->id) }}" method="POST" class="bg-gray-50 p-4 rounded-lg">
            @csrf
