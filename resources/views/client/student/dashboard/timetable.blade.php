    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        @if(isset($timetable))
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden mb-6">
                <div class="bg-blue-50 px-6 py-4 border-b border-blue-100">
                    <h3 class="text-lg font-semibold text-gray-800">Today's Timetable ({{ $today }})</h3>
                </div>
                <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            @if($period->period_type == 'regular')
                                                {{ $period->teacherRelation ? $period->teacherRelation->first_name . ' ' . $period->teacherRelation->last_name : 'N/A' }}
                                            @else
                                                -
                                            @endif
                                        </td>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm text-gray-500">No periods scheduled for today.</p>
                        </div>
                    @endif
                </div>
            </div>
                                                ...
                                                <div>
                                                    ...
                                                    @if($period->period_type == 'regular')
                                                        <p class="text-xs text-gray-500 mt-1">
                                                            Teacher: {{ $period->teacherRelation ? $period->teacherRelation->first_name . ' ' . $period->teacherRelation->last_name : 'N/A' }}
                                                        </p>
                                                    @endif
                                                </div>
        ...
        @else
            <div class="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 rounded" role="alert">
                <p>No timetable available for your class. Please contact your school administrator.</p>
            </div>
        @endif
    </div>
