...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        // \Illuminate\Foundation\Http\Middleware\ValidatePostSize::class, // Removed to allow larger uploads
    ...
    protected $middlewareAliases = [
        ...
        'ensure.saasAdmin' => \App\Http\Middleware\EnsureSaasAdmin::class,
